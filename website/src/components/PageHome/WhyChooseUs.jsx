        ...
        <Grid container justify="center" alignItems="center" spacing={16}>
          <Grid item xs={10} md={6} xl={3}>
            <Grid container spacing={16} alignItems="center" wrap="nowrap">
              <Grid item>
                <Excavator className={classes.Icon} />
              </Grid>
              <Grid item>
          ...
          <Grid item xs={10} md={6} xl={3}>
            <Grid container spacing={16} alignItems="center" wrap="nowrap">
              <Grid item>
                <MoneyBag className={classes.Icon} />
              </Grid>
              <Grid item>
                <Typography variant="h6" component="p" className={classes.Text}>
                  Выгодная стоимость
          ...
          <Grid item xs={10} md={6} xl={3}>
            <Grid container spacing={16} alignItems="center" wrap="nowrap">
              <Grid item>
                <Machinery className={classes.Icon} />
              </Grid>
              <Grid item>
                <Typography variant="h6" component="p" className={classes.Text}>
                  Постоянно обновляемая спецтехника
                </Typography>
              </Grid>
            </Grid>
          </Grid>
