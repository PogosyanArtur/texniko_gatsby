...
import homeBg_2 from "assets/images/main/bg_2.jpg";

const useStyles = makeStyles(theme => ({
  Container: {
    backgroundImage: `linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url(${homeBg_2})`,
      ...
      <Wrapper>
        <Paper className={classes.MassageBox}>
          ...
          <Typography variant="body1" className={classes.Text}>
            ...
            Chicago, IL. Motors is ultimate Car Dealer, Automotive, Auto Dealer
            WordPress theme.
          </Typography>
        </Paper>
      </Wrapper>
