...
import { Typography, Divider, GridList, GridListTile, ListSubheader } from '@material-ui/core'
    ...
    return (
        <Fragment>
            <section className={ classes.Banner }>
                <Wrapper>
                    <Typography variant="h1" color="textSecondary" className={ classes.Title }>Фотогалерея
            ...
            <section className={ classes.Content }>
                <Wrapper>
                    <GridList cols={ matches ? 1 : 3 } cellHeight={ 250 }>
                        <GridListTile key="Subheader" cols={ matches ? 1 : 3 } style={ { height: 'auto' } }>
                            <ListSubheader component="div" className={ classes.Header }>Мы в деле</ListSubheader>
                        </GridListTile>
                        {
                            imageData.map((tile, index) => (
                                <GridListTile key={ tile.name } cols={ matches ? 1 : tile.cols || 1 } onClick={ () => openLightBoxHandler(index) }>
